...
export function WavyBackground() {
  ...
  useEffect(() => {
    ...
    const waves = [
      new Wave(150, 0.01, 30, 2, 0.002, 'rgba(124, 255, 0, 0.1)', 20),
      new Wave(200, 0.012, 40, 1.5, 0.0025, 'rgba(124, 255, 0, 0.15)', 25),
      new Wave(250, 0.008, 35, 2.5, 0.003, 'rgba(124, 255, 0, 0.12)', 15),
      new Wave(350, 0.015, 45, 1.8, 0.0015, 'rgba(255, 255, 255, 0.08)', 30),
      new Wave(450, 0.01, 50, 2.2, 0.002, 'rgba(255, 255, 255, 0.06)', 18),
      new Wave(550, 0.013, 38, 2, 0.0028, 'rgba(124, 255, 0, 0.1)', 22),
    ]
